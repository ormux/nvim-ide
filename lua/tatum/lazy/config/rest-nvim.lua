...
--- rest.nvim custom keybinds
local opts = { noremap = false, silent = true }
local keymap = vim.keymap.set

keymap("n", "<localleader>rr", "<CMD>Rest run<CR>", opts)
keymap("n", "<localleader>ro", "<CMD>Rest open<CR>", opts)
keymap("n", "<localleader>rl", "<CMD>Rest last<CR>", opts)
keymap("n", "<localleader>rc", "<CMD>Rest cookies<CR>", opts)
